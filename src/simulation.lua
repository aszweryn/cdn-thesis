...
simulation.profiles = {
  ...
  backend_trad_075={
    {p=60, min=(2+150)*0.75, max=(30+500)*0.75,}, {p=85, min=(31+501)*0.75, max=(60+600)*0.75,}, {p=95, min=(61+601)*0.75, max=(200+2000)*0.75,}, {p=99, min=(201+2001)*0.75, max=(600+4000)*0.75,},
  },
  backend_trad_half={
    {p=60, min=(2+150)*0.5, max=(30+500)*0.5,}, {p=85, min=(31+501)*0.5, max=(60+600)*0.5,}, {p=95, min=(61+601)*0.5, max=(200+2000)*0.5,}, {p=99, min=(201+2001)*0.5, max=(600+4000)*0.5,},
  }
}
